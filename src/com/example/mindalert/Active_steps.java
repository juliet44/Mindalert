...
public class Active_steps extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_active_steps);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.active_steps, menu);
		return true;
	}
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			if(position==0){
				return new  Naturally();
				
				
			}
			else if(position==1){
				return new Spiritually();
			}
			else if(position==2){
	...
	public static class DummySectionFragment extends Fragment {
		...
		public class Naturally extends Fragment {
			...
			String [] does={"Stay connected","Get moving","Do things you love","Challenge negative thoughts"
		};
			ListView lst;
			 ...
			 lst.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1, int position,
						...
						if(position==0){
							...
							Intent i =new Intent(getActivity(),Naturally.class);
							startActivity(i);
						}
					}
					});
